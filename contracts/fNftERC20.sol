...
contract FNFTERC20 is ERC20, ERC721Holder {
    ...
    address public redeemBlacklist;
    ...
    /// @param _redeemBlacklist an optional address you can blacklist from the redemption process:
        ...
        )
    {
        ...
        redeemBlacklist = _redeemBlacklist;
        creator = msg.sender;
    ...
    function redeem() external payable {
        ...
        if ((balanceOf(msg.sender) * 100) / totalSupply < redeemThreshold)
        ...
        uint256 tokensToPayout = totalSupply() -
            (redeemBlacklist == address(0) ? 0 : balanceOf(redeemBlacklist)) -
